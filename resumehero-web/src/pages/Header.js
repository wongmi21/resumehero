                    ...
                    <Authenticated>
                        <LinkContainer to="/search">
                            <Navbar.Form pullLeft>
                                <FormGroup>
                                    <FormControl placeholder="Search Jobs" value={this.state.query} onChange={this.handleSearch.bind(this)} onFocus={this.handleFocus.bind(this)} />
                                </FormGroup>
                            </Navbar.Form>
                        </LinkContainer>
                    </Authenticated>
